...
class ShippingNoteGeneratorTest(unittest.TestCase):
    ...
    def test_should_generate_shipping_note_with_all_input_fields(self):
        result = self.shipping_note_generator.generate_shipping_note("ORD-123", "Wireless Headphones", 2,
                                                                     Customer("Jane", "Doe"),
    ...
    def test_should_include_customer_full_name(self):
        result = self.shipping_note_generator.generate_shipping_note("ORD-999", "Laptop", 1, Customer("John", "Smith"),
    ...
    def test_should_include_order_id_and_item_details(self):
        result = self.shipping_note_generator.generate_shipping_note("ORD-555", "Tablet", 5, Customer("Alice", "Brown"),
    ...
    def test_should_include_full_address_across_all_fields(self):
        result = self.shipping_note_generator.generate_shipping_note("ORD-777", "Monitor", 3, Customer("Emma", "Jones"),
    ...
    def test_should_include_quantity_correctly(self):
        result = self.shipping_note_generator.generate_shipping_note("ORD-321", "Keyboard", 10,
                                                                     Customer("Tom", "White"),
